...
public abstract class ServletTemplate extends HttpServlet{
	...
	private void imprimirHeader(HttpServletRequest request,HttpServletResponse response) throws IOException
	{
		...
		respuesta.println("                    </li>");
		respuesta.println("                    <li>");
		respuesta.println("                        <a href=\"RFC5.htm\"><i class=\"fa fa-fw fa-table\"></i> Consultar Pedidos</a>");
		respuesta.println("                    </li>");
		respuesta.println("                    <li>");
		respuesta.println("                        <a href=\"RFC6.htm\"><i class=\"fa fa-fw fa-table\"></i>Consultar Clientes</a>");
		respuesta.println("                    </li>");
		respuesta.println("                    <li>");
		respuesta.println("                        <a href=\"RFC7.htm\"><i class=\"fa fa-fw fa-table\"></i> Consultar Proveedores</a>");
		respuesta.println("                    </li>");
		respuesta.println("                    <li>");
